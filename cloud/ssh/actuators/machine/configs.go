...
// These configuration items are usually found in the provider-components.yaml
...
// In kubeadm, master and etcd are in the same nodes, so this concept is a bit conflated, and we should be delicate here
